 ...
 */
public class MyAXISSocketFactory implements SecureSocketFactory {
    /**
     ...
     * @param attributes
     */
    public MyAXISSocketFactory(@SuppressWarnings("unused") final Hashtable attributes) {
    ...
    public java.net.Socket create(final java.lang.String host, final int port, final StringBuffer otherHeaders, final BooleanHolder useFullURL) throws Exception {
        try {
            ...
            //final SSLSocketFactory fac = HttpsURLConnection.getDefaultSSLSocketFactory();
            ...
            Debug.debug("Cipher suites: "+MyUtil.arrayToString(socket.getSSLParameters().getCipherSuites()), 3);
