 ...
 *  Generated: Tue Sep 23 22:44:52 PDT 2008 
 * 
 */
...
public class DescribeImagesSample {
    ...
    public static void main(String... args) {
         ...
         * http://aws.amazon.com
         ***********************************************************************/
        String accessKeyId = "ncWH8w33CCaeQoFfTKVGcw";
        String secretAccessKey = "IXGSmoAIMbbWn3iSVOJTW8xY4wjV3kBbUZrTgw";
       ...
       // AmazonEC2 service = new AmazonEC2Client(accessKeyId, secretAccessKey);
         ...
         ***********************************************************************/
         ...
         config.setServiceURL("http://mayhem9.cs.ucsb.edu:8773/services/Eucalyptus");
         ...
         ***********************************************************************/
         DescribeImagesRequest request = new DescribeImagesRequest().withImageId("ami-a21affcb");
         
         //List<String> owners = new ArrayList<String>();
         //owners.add("amazon");
         //request.setOwner(owners);
