...
public class NGScriptGenerator extends ScriptGenerator{
  ...
  public boolean createXRSL(JobInfo job, String exeFileName, String xrslFileName, boolean join){
    ...
    try{
      ...
      writeLine(bufXRSL,"(\""+shortExeFileName+"\" \""+exeFileName+"\")");
      ...
      try{
        GridPilot.getClassMgr().getCSPluginMgr().getShellMgr(
            csName).writeFile(xrslFileName, bufXRSL.toString(), false);
      }
      ...
      try{
        GridPilot.getClassMgr().getCSPluginMgr().getShellMgr(
            csName).writeFile(exeFileName, bufScript.toString(), false);
      }
